...
if (!$con)
  ...
  $alert = 'Could not connect to DB, Check db credentials and try again :)';
  	...
  	if (!$con2)
	{
		...
		$installed = "Thank you for purchasing from CodeCanopy any further problems please email support@codecanopy.com you can login your admin panel here: <a class='btn btn-success' href='http://".$URL."/admin'>Admin Panel</a>";
		...
		$remove = "Please delete install.php and upgrade.php";
		}
...
echo '<div class="alert alert-error">
  ...
  <strong>Script Installed!</strong> '.$remove.'
</div>';
}
...
echo '<div class="alert alert-success">
  <button type="button" class="close" data-dismiss="alert">×</button>
  <strong>Script Installed!</strong> '.$installed.'
</div>';
}
...
<div class="box well">
	<center>Already have v1.6+ installed and want to upgrade <a href="upgrade.php">click here</a>.</center>
</div>
